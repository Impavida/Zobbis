...
At its core, Zobbis provides a private messaging infrastructure designed deliberately
without social-network mechanics. The messaging layer itself is not the product,
but a supporting system that enables meaningful, real-world encounters.
...
in a controlled and temporary manner.
...
The messaging foundation is built first and must reach a stable and well-defined
state before additional domains or features are considered.
